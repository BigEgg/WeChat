...
import com.thoughtworks.wechat_application.resources.admin.basicSettings.WeChatBasicSettingsResource;
...
public class WeChatApplication extends Application<WeChatApplicationConfiguration> {
    ...
    private void registResource(final Environment environment) {
        ...
        environment.jersey().register(injector.getInstance(WeChatBasicSettingsResource.class));
    }
