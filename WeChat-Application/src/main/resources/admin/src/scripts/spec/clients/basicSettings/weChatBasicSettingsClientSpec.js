describe('WeChat Basic Settings Client Test', function () {
    ...
    describe('when get WeChat connection status', function () {
        it('return status when success', inject(function ($rootScope, $q, weChatBasicSettingsClient) {
            spyOn(mockOAuthApiHelper, 'get').and.callFake(function (url) {
                if (url === '/api/admin/wechat/status') {
            ...
            expect(mockOAuthApiHelper.get).toHaveBeenCalledWith('/api/admin/wechat/status');
        }));
    ...
    describe('when get WeChat server info', function () {
        it('return server info when success', inject(function ($rootScope, $q, weChatBasicSettingsClient) {
            spyOn(mockOAuthApiHelper, 'get').and.callFake(function (url) {
