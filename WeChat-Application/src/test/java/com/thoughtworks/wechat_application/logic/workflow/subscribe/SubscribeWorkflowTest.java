...
public class SubscribeWorkflowTest {
    ...
    public void testInject() throws Exception {
        ...
        final SubscribeWorkflow workflow = injector.getInstance(SubscribeWorkflow.class);
    ...
    public void testInject_Singleton() throws Exception {
        ...
        final SubscribeWorkflow workflow = injector.getInstance(SubscribeWorkflow.class);
        final SubscribeWorkflow anotherWorkflow = injector.getInstance(SubscribeWorkflow.class);
